...
urlpatterns += [
      path('document/<int:document_id>/generate-semester-plan/', 
         views.generate_semester_plan_view, 
         name='generate_semester_plan'),
         
    
    path('semester-plan/<int:id>/', views.semester_plan_detail, name='semester_plan_detail'),
    ...
    path('document/<int:document_id>/', views.document_detail, name='document_for_teacher'),
    path('document/<int:document_id>/', views.document_detail, name='document_detail'),
    path('quiz/<int:quiz_id>/download/', views.download_quiz_as_file, name='download_quiz'),
